...
When('I click {string} button for {string}', async function (this: CustomWorld, button: string, currency: string) {
    await this.depositPage.clickActionButtonForCurrency(button, currency);
});
